...
$(document).ready(function () {
    ...
    const games = [{
        ...
        },
        {
            ...
            description: "Age of Empires II: Definitive Edition celebrates the 20th anniversary of one of the most popular strategy games ever, now with stunning 4K Ultra HD graphics, and a fully remastered soundtrack. Age of Empires II: DE features “The Last Khans” with 3 new campaigns and 4 new Civilizations. Frequent updates include events, additional content, new game modes, and enhanced features with the recent addition of Co-Op mode! Explore all the original Campaigns and the best-selling expansions like never before. With over 200 hours of gameplay and 1,000 years of human history, improved experiences await. Head online to challenge other players in your quest for world domination with 35 different Civilizations. You can also experience new Civilizations and Campaigns with the Lords of the West DLC! Recent updates include a Battle Royale game mode, ongoing support for the Scenario Editor, Quick Play for easy social games, enhancements to the game UI, and more! Choose your path to greatness with an eye-catching and engaging remaster to one of the most beloved strategy games of all time.",
            genre: "Strategy",
            platform: "PC, Xbox",
        ...
        },
        {
            ...
            description: "You explore a dangerous grey land, unearthing coloured fragments on a journey to find your missing mother. As obstacles match the background, they disappear, creating new and exciting puzzles - full of peril, mystery… and colours unseen. Unique colour-matching mechanic, offering a new twist on the classic adventure game. A heartfelt story that touches on themes of love, loss, existence and remorse. A world full of lively characters to talk to, each with their own personality and story. Stark silhouetted art style with bright, bold colours",
        ...
        },
        {
            ...
            description: "For a thousand years, the battle has been waged. The sole reason humans and elves are locked in a neverending war: The Stick of Truth. But the tides of war are soon to change as word of a new kid spreads throughout the land, his coming fortold by the stars. As the moving vans of prophecy drive away, your adventure begins. Arm yourself with weapons of legend to defeat underpants gnomes, hippies and other forces of evil. Discover the lost Stick of Truth and earn your place at the side of Stan, Kyle, Cartman and Kenny as their new friend. Succeed, and you shall be South Park's savior, cementing your social status in South Park Elementary. Fail, and you will forever be known… as a loser.",
            genre: "RPG, Adventure",
            platform: "PC, Playstation, Xbox, Switch",
...
//sort functions
    ...
    function populateDetails(imageId) {
        ...
        <h1>${games[imageId - 1].name}</h1>
        <h3>${games[imageId - 1].header}</h3>
        <h3>${games[imageId - 1].price}</h3>
        <div class="game-stuff">
            <p>${games[imageId - 1].genre}</p>
            <p>${games[imageId - 1].platform}</p>
        </div>
        <p>${games[imageId - 1].description}</p>
